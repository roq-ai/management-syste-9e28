  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Management System - Streamlining User Management for Enhanced Efficiency and Optimal Business Performance."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Welcome to Management System - Streamlining User Management for Enhanced Efficiency and Optimal Business Performance.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx1c2VyJTIwbWFuYWdlbWVudCUyQ2FwcGxpY2F0aW9ufGVufDB8fHx8MTY4ODk5MDk4MHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
